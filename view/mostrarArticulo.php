<div class="row">
    ...
    ?>
        ...
        <div class="col" style="border: 2px solid gray; border-radius: 5px;">
        ...
        <div class="col-md-2" style="border: 2px solid gray; border-radius: 5px; margin-left: 1em;">
            ...
            <select class="custom-select btn-primary text-white" name="cantidad" id="cantidad" style="margin-top: 1em; margin-bottom: 1em; background-color: rgb(0, 123, 255);"></select>
