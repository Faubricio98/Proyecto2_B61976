<div class="row">
    ...
    <div class="col-md-4">
        ...
        <button id="logInAdm" onclick="logAdm($('#userAdmin').val(), $('#passAdmin').val())" class="btn btn-primary">Iniciar Sesi&oacute;n</button>
    ...
    <div class="col-md-4">
        ...
        <button id="logInClient" onclick="logInCliente($('#userClient').val(), $('#passClient').val())" class="btn btn-primary">Iniciar Sesi&oacute;n</button>
        <button id="signInClient" onclick="signInCliente()" class="btn btn-primary">Registrarse</button>
